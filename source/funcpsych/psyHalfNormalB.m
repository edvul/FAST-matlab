% function [varargout] = psyNormalB(nchoice, parameter, yscrit, ys, rs, ps);
...
function [varargout] = psyHalfNormalB( nchoice, widthparameter, yscrit, ys, rs, ps); % params, xs, ys, rs
...
parameter = 1./widthparameter; % exponent, same as psyNormal2 slope argument
